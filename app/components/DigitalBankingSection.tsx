...
// // Shared Checkmark component for this section
// const CheckItem = ({ text }: { text: string }) => (
//   <div className="flex items-center gap-2">
//     <div className="mt-0.5 flex h-3.5 w-3.5 shrink-0 items-center justify-center rounded-full bg-[#0057FF] text-white shadow-md shadow-blue-500/20">
//       <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" className="h-2 w-2">
...
//   return (
//     <>
//       <section className="relative overflow-hidden bg-[#E9F4F9] py-16 md:py-20 bg-[url('/images/bg-vector.png')] bg-size-[280px] bg-[position:left_center] bg-no-repeat">
//         <div className="page-center-nudge relative z-10 mx-auto w-full max-w-[1120px] flex flex-col gap-12 px-5 md:px-0 bg-[url('/images/N7.png')] bg-size-[680px] bg-[position:center_top] bg-no-repeat">
...
//         </div>
//       </section>
//       <section className="relative bg-[#E9F4F9] py-16 md:py-20 bg-[url('/images/take-full-adv-bg.png')] bg-contain bg-[position:left_center] bg-no-repeat">
//            <CTACard brand="N7" />
//       </section>
//     </>
//   );
